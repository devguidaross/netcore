namespace Api2.Api1
{
    public partial class Api1Client
    {
        ...
        public Api1Client(string baseUrl)
        {
            BaseUrl = baseUrl;
        ...
        public System.Threading.Tasks.Task<int> TaxaJurosAsync()
        {
            return TaxaJurosAsync(System.Threading.CancellationToken.None);
        }
        ...
        {
            return System.Threading.Tasks.Task.Run(async () => await TaxaJurosAsync(System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<int> TaxaJurosAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/TaxaJuros");
